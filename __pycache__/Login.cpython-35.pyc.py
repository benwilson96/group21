...
def insert_account(Page,UN,PW,Admin):
    db = pymysql.connect(host="csmysql.cs.cf.ac.uk", user="c1531722", passwd="pE9zby3j", db="c1531722")
    cursor = db.cursor()
...
class Register(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        RegBtn = ttk.Button(self, text="Register", command= lambda: insert_account(self, UserN_input,PW_input,1))
        RegBtn.pack(side = BOTTOM)
